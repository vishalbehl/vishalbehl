...
const exp = [
  {
    ...
    place: "GURUGRAM POLICE CYBER CELL",
    time: "(June, 2021 - present)",
    desp: "<li>Worked with some of the Highly Qualified Cyber Security Expert and under the guidance of Mr. Rakshit Tandon Sir.</li> <li>Gained knowledge about What type of Cyber Crimes happening around us and how to deal with it.</li>",
  },
  // {
